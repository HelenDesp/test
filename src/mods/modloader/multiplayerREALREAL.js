  ...
  globalThis.ovoMultiplayerClient = {
    initMod() {
      (function () {
        ...
        globalThis.spawnTextOnTitleLogo = (text="REv" + VERSION) => {
        ...
        let multiplayer = {
          init() {
            ...
            if (
              ...
              // getDialogAlert({
              //   type: "success",
              //   text: "REvO Online is currently in open beta.<br>We will do our best to fix any issue as quickly as we can.<br>Thank you for playing!",
              // }).then(() => {
              //   this.lastPromptId = thisPromptId;
